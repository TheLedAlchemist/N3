...
def main():
    ...
    measurement_file_exists = os.path.exists(f"{args.out_path}_growing_compact_measurements.csv")
    ...
    with open(f"{args.out_path}_growing_compact_measurements.csv", "a") as f:
